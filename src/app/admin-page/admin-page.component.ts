...
export class AdminPageComponent {
  ...
  constructor (private faService: FaServiceService,private userService:UserServicesService, private popup:PopupService) { }
 ...
 data = [{labels: 'red'}]
  ...
  downloadData(option : any) {
    ...
    this.faService.downloadFeedback(tableName,this.startDate,this.endDate,this.selectedRating)
